...
# while preserving native/full-precision KV. OOM recovery may only shrink prefill
# chunks; it may not quantize KV, truncate context, or shorten the token allowance.
