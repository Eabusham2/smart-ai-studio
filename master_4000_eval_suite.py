...
# Preserve the existing live branch display, but use only the native/full-precision
# generator. No KV quantization, sliding window, context compaction, or lossy OOM path.
