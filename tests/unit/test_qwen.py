...
class TestQwenReasoningCapabilities(unittest.TestCase):
    def setUp(self):
        ...
        # These tests validate Qwen-facing contracts and the synthetic consolidation
        # path. They must never download a real Qwen checkpoint in CI.
